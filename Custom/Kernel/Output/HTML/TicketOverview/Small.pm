...
# --
# $origin: Znuny - 460ef44565300c6b979b0743833e3800fdbebf81 - Kernel/Output/HTML/TicketOverview/Small.pm
# --
...
#    $Self->{UserID} = $Param{UserID} || die "Got no UserID!";
    $Self->{UserID} = $Param{UserID} || die "Got no UserID!"; ## no critic
# ---
...
#     };
    ...
    if(!$Param{AdvancedEngine}->{ShortName} || $Param{AdvancedEngine}->{ShortName} ne 'ES'){
        $Self->{ValidSortableColumns} = {
            'Age'                    => 1,
            'Created'                => 1,
            'Owner'                  => 1,
